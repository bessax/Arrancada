/*
 * ConfiguraRelatorioCompetidor.java
 *
 * Created on 3 de Fevereiro de 2008, 18:47
 */

package arrancada.Formularios;

import arrancada.Relatorios.GeraRelatorioCompetidor;
 ...
 * @author  Bessa
 */
public class ConfiguraRelatorioCompetidor extends javax.swing.JDialog {
    
    /** Creates new form ConfiguraRelatorioCompetidor */
    public ConfiguraRelatorioCompetidor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Relatório de Competidor");
    ...
    private void jButtonVizualizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonVizualizarMouseClicked
        try {
            if(estado==1) {
                new GeraRelatorioCompetidor().montaRelatorio(2,"Competidor", jTextFieldIni.getText(), jTextFieldFim.getText());
                } 
                 else if(estado ==0){
                jTextFieldIni.setEnabled(false);
                jTextFieldFim.setEnabled(false);
                new GeraRelatorioCompetidor().montaRelatorio(1,"Competidor","","");
            }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfiguraRelatorioCompetidor dialog = new ConfiguraRelatorioCompetidor(new javax.swing.JFrame(), true);
