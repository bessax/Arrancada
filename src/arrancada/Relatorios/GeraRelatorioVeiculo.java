...
public class GeraRelatorioVeiculo{
// Objeto de interação com Banco da Aplicação
    ...
    private  ResultSet realizaConsulta(int consulta,String valor,String valor2,String valor3,String valor4)
    {
        
        switch( consulta ){
                case 1:   rs = servico.selectVeiculo("","0");
                           jrXml = path + "veiculo.jrxml";
                           break;                           
                                         
                case 2:    rs = servico.selectVeiculo(valor,valor2,"0","","");
                           jrXml = path + "veiculo.jrxml";
                            break; 
                case 3:    rs = servico.selectVeiculo(valor,valor2,"1","","");
                           jrXml = path + "veiculo.jrxml";
                            break; 
                case 4:    rs = servico.selectVeiculo(valor,valor2,"2",valor3,valor4);
                           jrXml = path + "veiculo.jrxml";
                            break;             
    ...
    public final void montaRelatorio(int relatorio, String title,String valor,String valor2,String valor3,String valor4) throws JRException
    {
        try{         
      ...
      JRResultSetDataSource jrRS = new JRResultSetDataSource(realizaConsulta(relatorio,valor,valor2,valor3,valor4));
