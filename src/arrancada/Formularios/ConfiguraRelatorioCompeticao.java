/*
 * ConfiguraRelatorioCompeticao.java
 *
 * Created on 3 de Fevereiro de 2008, 19:50
 */

package arrancada.Formularios;

import arrancada.Relatorios.GeraRelatorioCompeticao;
 ...
 * @author  Bessa
 */
public class ConfiguraRelatorioCompeticao extends javax.swing.JDialog {
    
    /** Creates new form ConfiguraRelatorioCompeticao */
    public ConfiguraRelatorioCompeticao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Relatório de Competição");

        jPanel1.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jComboBoxOpcoes.setFont(new java.awt.Font("Tahoma", 1, 11));
        jComboBoxOpcoes.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "--- Selecione ---", "Geral", "Específico", "Competição", "Data" }));
        ...
        dateChooserCombo1.setCalendarBackground(new java.awt.Color(255, 255, 204));
        dateChooserCombo1.setEnabled(false);

        dateChooserCombo2.setCalendarBackground(new java.awt.Color(255, 255, 204));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTextFieldFim, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButtonVizualizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonVizualizarMouseClicked
        try {
            if(estado==1) {
                ...
                new GeraRelatorioCompeticao().montaRelatorio(4,"Competição", jTextFieldIni.getText(), jTextFieldFim.getText(),dateChooserCombo1.getText(),dateChooserCombo2.getText(),"3");
            }
            else if(estado==2)
            {
               
             new GeraRelatorioCompeticao().montaRelatorio(3,"Competição",dateChooserCombo1.getText(),dateChooserCombo2.getText(),"","","2");   
            }
             else if(estado==3)
            {
              
             new GeraRelatorioCompeticao().montaRelatorio(2,"Competição",jTextFieldIni.getText(), jTextFieldFim.getText(),"","","1");   
            }
            else if( estado == 0){
              
                new GeraRelatorioCompeticao().montaRelatorio(1,"Competição","","","","","");
            }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfiguraRelatorioCompeticao dialog = new ConfiguraRelatorioCompeticao(new javax.swing.JFrame(), true);
