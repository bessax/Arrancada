/*
 * ConfiguraRelatorioPiloto.java
 *
 * Created on 3 de Fevereiro de 2008, 16:38
 */

package arrancada.Formularios;

import arrancada.Relatorios.GeraRelatorioPiloto;
 ...
 * @author  Bessa
 */
public class ConfiguraRelatorioPiloto extends javax.swing.JDialog {
    
    /** Creates new form ConfiguraRelatorioPiloto */
    public ConfiguraRelatorioPiloto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
       ...
       try 
        {
         if(estadoComboBox==1)
         {
             new GeraRelatorioPiloto().montaRelatorio(2, "Piloto", jTextFieldIni.getText(), jTextFieldFim.getText());
         }
         else if(estadoComboBox ==0){
              jTextFieldIni.setEnabled(false);
              jTextFieldFim.setEnabled(false);
              new GeraRelatorioPiloto().montaRelatorio(1, "Piloto","", "");
         }
        } 
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfiguraRelatorioPiloto dialog = new ConfiguraRelatorioPiloto(new javax.swing.JFrame(), true);
