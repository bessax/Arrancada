 ...
 * @author Bessa
 */
public class GeraRelatorioPuxada {
// Objeto de interação com Banco da Aplicação
    ...
    private  ResultSet realizaConsulta(int consulta,String valor1,String valor2,String competicao1,String competicao2,String data1,String data2,String categoria1,String categoria2)
    {
        
        switch( consulta ){
                case 1:   rs = servico.selectPuxada("","","","1");
                           jrXml = path + "puxada.jrxml";
                           break;                           
                                         
               case 2:    rs = servico.selectPuxada(valor1,valor2,"","","","","","","1");
                           jrXml = path + "puxada.jrxml";
                            break;   
                case 3:    rs = servico.selectPuxada("","",competicao1,competicao2,"","","","","2");
                           jrXml = path + "puxada.jrxml";
                            break; 
                case 4:    rs = servico.selectPuxada("","","","",data1,data2,"","","3");
                           jrXml = path + "puxada.jrxml";
                            break; 
               case 5:    rs = servico.selectPuxada("","","","","","",categoria1,categoria2,"4");
                           jrXml = path + "puxada.jrxml";
                            break;  
               case 6:    rs = servico.selectPuxada(valor1,valor2,competicao1,competicao2,data1,data2,categoria1,categoria2,"5");
                           jrXml = path + "puxada.jrxml";
                            break;               
    ...
    public final void montaRelatorio(int relatorio, String title,String valor1,String valor2,String competicao1,String competicao2,String data1,String data2,String categoria1,String categoria2) throws JRException
    {
        try{         
      ...
      JRResultSetDataSource jrRS = new JRResultSetDataSource(realizaConsulta(relatorio,valor1,valor2,competicao1,competicao2,data1,data2,categoria1,categoria2));
